          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p className="text-gray-400">
                We collect information you provide directly to us, such as when you create a Digital Book ID,
            ...
            <section>
              ...
              <p className="text-gray-400">
                We use the information we collect to provide, maintain, and improve our digital book access services,
            ...
            <section>
              ...
              <p className="text-gray-400">
                ...
                support channel or email us at support@digitalbookid.com.
              </p>
            </section>
          </CardContent>
        </Card>
