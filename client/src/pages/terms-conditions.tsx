      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <Card className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700">
          <CardHeader>
            ...
            <p className="text-center text-gray-400">Last updated: August 2025</p>
          </CardHeader>
          <CardContent className="space-y-6">
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">Acceptance of Terms</h2>
              <p className="text-gray-400">
                By accessing and using our Digital Book ID services, you accept and agree to be bound by
            ...
            <section>
              ...
              <p className="text-gray-400">
                Digital Book ID provides services for accessing various digital books and reading platforms. Our services are intended for personal, non-commercial use only.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-400">
                Users are responsible for maintaining the confidentiality of their Digital Book ID credentials
            ...
            <section>
              ...
              <p className="text-gray-400">
                ...
                the terms of service of connected reading platforms.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-400">
                Digital Book ID shall not be liable for any indirect, incidental, special, consequential,
